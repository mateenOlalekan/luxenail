...
import {   Phone,  Calendar,  Sparkles,  Heart,  Menu,  X,  ChevronDown,  Scissors,  Palette,  Crown,  Clock,  MapPin,  Instagram,  Facebook,} from 'lucide-react';
          ...
          <div className="bg-white w-full max-w-lg rounded-2xl shadow-xl p-6 relative animate-fadeIn">
            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                <select className="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-pink-500 focus:outline-none">
        ...
        <div className="lg:hidden fixed top-20 inset-x-0 z-50 bg-white/95 backdrop-blur-md shadow-2xl animate-slideIn border-b border-pink-100 max-h-[80vh] overflow-y-auto">
          <div className="px-4 pt-6 pb-8 space-y-1">
            ...
            <div className="pt-6 pb-4 border-t border-pink-100 mt-6">
              ...
              {/* Full-width booking button for mobile */}
              <Link 
                href="/booking" 
            ...
            {/* Enhanced Contact info with social links */}
